//
//  EmpUsageAgreementViewController.swift
//  CWA
//
//  Created by NFC Solutionsusa on 26/12/17.
...
import WebKit
import SwiftyJSON
class EmpUsageAgreementViewController: BaseViewController,WKNavigationDelegate {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.titlelbl.text = "Employee Usage Agreement"
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        //        let urlString:String = "https://apps.tempositions.com/cwa/Login"
    ...
    func approveEmpAgreementCall() {
        ...
        if isInternetAvailable {
            ...
            RestAPI.approveEmpAgreement(self, params: params, method: "POST", accessToken: "", acces: true, callBack: getResponse(response:))
    ...
    func getSafetyGuidlines() {
        ...
        if isInternetAvailable {
            ...
            let defaults = UserDefaults.standard
            var  ContactId = String(format:"%d", defaults.integer(forKey: "ContactId"))
            let clientID = String(format:"%d", defaults.integer(forKey: "ClientID"))
            let DivisionId = String(format:"%d", defaults.integer(forKey: "DivisionId"))
    ...
    func PushToSafetyGuidlinesPage(AgreementText: String, EuaId: String, checkAgreementMsg: String, IsAgree: String,Agrementfooter: String,titleName: String, showSkip: String){
        ...
        if isControllerExists == false{
            ...
            nextViewController.isFromSafetey = false
            self.navigationController?.pushViewController(nextViewController, animated: true)
        }else{
            self.navigationController?.popViewController(animated: true)
        }
