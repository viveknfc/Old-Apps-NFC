...
class ROSOfficeViewController: BaseTableViewController,UIGestureRecognizerDelegate,UIAlertViewDelegate,FSCalendarDataSource, FSCalendarDelegate,FSCalendarDelegateAppearance  {
    ...
    func getHospitalitySearchedEmployee(){
        ...
        if isInternetAvailable {
            ...
            let params :[String:String] = ["position" : position ,"profileId": profileId , "clientId" : clientID ,"startDate" : StartDate, "endDate" : EndDate,"allowOT":"1","noOfOrders":String(format:"%d",TempEmployeesNeeded),"sortBy":"1","PositionTitle":selectedPositionType.PositionName!]
        ...
        if tableView.tag == empTblViewTag{
            ...
            if tableView.tag == mainTblViewTag{
                ...
                if placeholder == PositionPlaceHolder || placeholder == ReasonForPositionPlaceHolder || placeholder == ReportToLocationPlaceHolder || placeholder == ReportToPlaceHolder || placeholder == EmployeesNeededPlaceHolder || placeholder == JobTitlePlaceHolder
                {
                    ...
                    //textView
                    if placeholder.contains("Additional Comments for Employees")
                    {
                        //textView
    ...
    override  public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath){
        ...
        if tableView.tag == mainTblViewTag{
            ...
            }else if placeholder.contains("Meal Break"){
    ...
    func segmentTableViewCell(tableView: UITableView) -> SegmentTableViewCell {
        ...
        }else if self.sameDayHour == "0" && self.multiDayHour == "0" {
            cell.lblTimeDiff.text = "0"
...
extension ROSOfficeViewController:searchEmpDelegate{
...
extension ROSOfficeViewController:addReportToDelegate{
...
extension ROSOfficeViewController:SummaryDelegate{
...
extension ROSOfficeViewController: UITextViewDelegate{
...
extension ROSOfficeViewController: UITextFieldDelegate{
    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        if textField.tag == empNeededTxtFieldTag || textField.tag == jobTitleTxtFieldTag  {
