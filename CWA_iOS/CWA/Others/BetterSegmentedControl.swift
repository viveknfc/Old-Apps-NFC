...
@IBDesignable open class BetterSegmentedControl: UIControl {
    ...
    public var titles: [String] {
        ...
        set {
            ...
            let labels: [(UILabel, UILabel)] = newValue.map {
                ...
                selectedTitleLabel.font = UIFont.systemFont(ofSize: 14)
                ...
                case .pad:
                    ...
                    selectedTitleLabel.font = UIFont.systemFont(ofSize: 16)
                    break
                case .phone:
                    break
                case .tv:
    ...
    fileprivate lazy var defaultTitles: [String] = { return ["Today", "Upcoming","Past"] }()
    ...
    required public init?(coder aDecoder: NSCoder) {
        ...
        super.init(coder: aDecoder)
        if self.tag == 101 {
            defaultTitles = ["Same Daily Hours", "Multi Daily Hours"]
        }else if  self.tag == 1002 {
            defaultTitles = ["Profile", "Change Password","Reviews"]
        }
